...
* [rFSM](https://github.com/kmarkus/rFSM) (optional)
...
* Install [graphviz for windows](https://graphviz.gitlab.io/_pages/Download/windows/graphviz-2.38.msi) and set/update the corresponding enviornment variables (`GRAPHVIZ_ROOT` and `PATH`): 
```
